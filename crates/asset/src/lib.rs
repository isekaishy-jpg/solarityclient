...
pub use model::{
    ...
    M2CollisionMesh, M2ColorAnimation, M2Interpolation, M2Light, M2LightKind, M2Material,
    M2ModelBounds, M2ParticleEmitter, M2ParticleLifetimeTrack, M2RibbonEmitter, M2Sequence,
