...
pub use database::{
    ...
    CreatureFamilyDefinition, CreatureModelAppearance, CreatureModelData, CreatureMovementSounds,
    GameObjectDisplayCatalog, GameObjectDisplayInfo, HelmetGeosetVisibility,
