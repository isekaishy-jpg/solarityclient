...
pub use database::{
    ...
    CreatureModelAppearance, CreatureModelData, GameObjectDisplayCatalog, GameObjectDisplayInfo,
    ...
    LiquidTypeCatalog, LiquidTypeDefinition, LoadingScreenCatalog, LoadingScreenDefinition,
