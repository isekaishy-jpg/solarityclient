...
pub use database::{
    ...
    SoundEntry, SoundEntryCatalog, SpellEffectCatalog, SpellEffectDefinition, SpellItemEnchantment,
    SpellNameCatalog, SpellVisualEffectCatalog, SpellVisualEffectDefinition, TaxiPathNode,
