...
pub use database::{
    ...
    GameObjectDisplayInfo, HelmetGeosetVisibility, HelmetGeosetVisibilityCatalog, InventoryType,
    ...
    LightSkybox, LiquidMaterialCatalog, LiquidMaterialDefinition, LiquidTypeCatalog,
    LiquidTypeDefinition, LoadingScreenCatalog, LoadingScreenDefinition, MapCatalog, MapDefinition,
    MapDifficultyCatalog, MapKind, ModelLightColors, MovementSoundCatalog,
