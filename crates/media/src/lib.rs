...
pub use audio::{
    ...
    SoundCategorySettings, SoundChannel, SoundChannelError, SoundConcurrencyMode, SoundDecodeError,
    SoundDecodeMode, SoundDecoder, SoundEngine, SoundEngineError, SoundEngineSettings, SoundGain,
    SoundGainError, SoundLoopMode, SoundOutput, SoundOutputInfo, SoundOutputTarget,
    SoundPlayRequest, SoundPlayback, SoundResidencyPolicy, SoundSpatialPosition,
