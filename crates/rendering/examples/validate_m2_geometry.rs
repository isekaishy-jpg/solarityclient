...
fn main() -> Result<(), Box<dyn Error>> {
    ...
    for (particle_index, particle) in model.animations().particles().iter().enumerate() {
        ...
        let textures = particle
            ...
            .collect::<Vec<_>>();
        println!(
            "particle={particle_index} id={} bone={:?} emitter_type={} particle_type={} head_or_tail={} blend={} flags={:#010X} priority={} position={:?} animated_position={animated_position:?} atlas={}x{} speed={} gravity={} life={} rate={} area={}x{} scale={:?}/{:?} twinkle={}/{:?} wind={:?} drag={} spin={}+/-{} textures={textures:?}",
            particle.id(),
            particle.bone_index(),
