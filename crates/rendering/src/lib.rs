...
pub use terrain::{
    ...
    TerrainRenderVertex, TerrainSceneUniform, TerrainTextureAnimationState, TerrainTileMeshPlan,
    TerrainTileMeshPlanError, WorldHorizonScale, WorldLowDetailFrame, WorldShadowProjection,
