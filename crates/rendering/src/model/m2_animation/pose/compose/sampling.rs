//! Parent-first sampling, overlays and native billboard composition.

use super::super::super::quaternion::quaternion_matrix;
use super::super::super::sample::{sample_discrete, sample_quaternion, sample_vec3};
use super::{
    BillboardView, M2AnimationClock, M2BonePose, M2BonePoseError, M2BonePoseOverrides,
    M2FingerPoseHands, finite_matrix,
};
