...
use solarity_asset::{M2AnimationSet, M2ParticleEmitter};

use crate::model::m2_animation::sample::{sample_discrete, sample_scalar};
...
impl M2ParticlePose {
    ...
    pub fn sample(
        ...
        Ok(Self {
            ...
            gravity: scalar(emitter.gravity(), 0.0),
    ...
    /// Returns the animated downward acceleration.
    #[must_use]
