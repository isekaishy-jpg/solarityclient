...
pub(in crate::application) use gpu::{LiquidGpuBatch, LiquidGpuMaterialCache};
...
pub(in crate::application) use world_model::{
    ResidentWorldModelLiquidBatch, WorldModelLiquidLighting, prepare_world_model_liquids,
};
