...
impl FollowAngle {
    ...
    /// Native reversal clears the goal before considering the existing transition.
    pub(super) fn set_goal(&mut self, goal: f32) {
        self.goal = goal;
    }
...
#[cfg(test)]
#[path = "../../../tests/application/player_camera_follow.rs"]
mod tests;
