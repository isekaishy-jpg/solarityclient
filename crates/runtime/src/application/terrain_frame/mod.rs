...
use solarity_rendering::{
    BlpColorSpace, BlpTextureUploadError, M2BonePoseError, M2LocalLightCount, M2MaterialPoseError,
    M2MeshPlanError, M2ParticleMeshPlanError, M2ParticleSimulationError, M2ParticleSpirvError,
    M2RibbonMeshPlanError, M2RibbonSpirvError, M2RibbonTrailError, M2ShaderPlanError, M2SpirvError,
    TerrainLayerCount, TerrainLayerCountError, TerrainPreparedDraw, TerrainTextureSet,
    TerrainTileMeshPlan, VulkanError, VulkanRenderer, WorldCameraError, WorldModelBaseMip,
    WorldModelMeshPlanError, WorldModelPlacementError, WorldModelTextureFiltering,
};
use thiserror::Error;

use crate::application::game_object_coordinator::GameObjectFrameInput;
use crate::application::liquid::{
    LiquidGpuBatch, LiquidGpuMaterialCache, ResidentTerrainLiquidBatch,
};
...
impl TerrainFrame {
    ...
    pub(super) fn prepare(
        ...
        Ok(Self {
            ...
            sky: sky::WorldSkyPreparation::new(),
