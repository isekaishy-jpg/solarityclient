...
| Weather and sky | Complete precipitation presentation and retirement, weather ambience, and the global sky override/screen-effect provider. WMO sky visibility and replacement, weather palette/cloud-light transitions and authored skyboxes have implemented paths. |
