...
| Buildings and portals | Surface selection and per-group surface fog routing are integrated, with native callback and controlled GPU coverage. Complete WMO liquid and attached-doodad visibility/fog consumers and indoor/exterior sky visibility, then validate their combined live presentation. |
