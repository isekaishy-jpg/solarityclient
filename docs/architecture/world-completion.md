...
| Weather and sky | Complete precipitation presentation and retirement, weather ambience, and the screen-effect manual fog, postprocessing and sound consumers. WMO sky visibility and replacement, global screen-effect lighting/skybox selection, weather palette/cloud-light transitions and authored skyboxes have implemented paths. |
