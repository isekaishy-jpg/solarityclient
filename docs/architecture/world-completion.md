...
| Travel and streaming | Unit/vehicle base passenger frames, final local/remote projections, settled animated seats and remote boarding/exit transitions are connected, with nested-parent, mounted-rider, execution-order and lifetime tests. Local-player boarding, unloaded-child targets, seated animation routing, vehicle transfer/destruction callbacks, special cameras and combined live travel remain open. Validate admission, disappearance, lighting/fog transitions, and complete scene publication while moving through the world. Trace publication and first-use costs; fix critical costs discovered. Stationary offline timing does not establish populated-world behavior. |
