...
| Particles, spells, and aura visuals | Ordinary particle owner-opacity blending/alpha testing and ribbon birth opacity now follow their distinct native submission paths, with native state, Vulkan pixel and runtime history coverage. Complete the remaining specialized particle paths and general spell/aura visual consumers and lifecycles. Validate attachment, ordering, visibility, and retirement together. Track checks blocked by missing spell or other gameplay implementation explicitly. |
